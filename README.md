...
I'm Lucas and I'm Senior Software Engineer focused on distributed systems, high-performance computing and low-latency software design at scale. I work with HPP driven optimizations on highly demandable infrastructure, 
bringing a mathematical and research bounded development to software engineering.
...
Research and Engineering focus Shared/Distributed Memory, CPU Micro Architecture, NUMA-aware execution, SIMD, Caching, Parallelism/Concurrency-Aware Design, Multithreading, Async/Non-blocking IO, 
...
• +15 years with C# .NET: NET Core, EF Core, Dapper, Polly, TestContainers, Hangfire, Quartz, Akka, Dapr, Aspire.
...
• Distributed & Event-Driven: Kafka, RabbitMQ, EventGrid, Flink, Airflow, Redis, Apache Ignite.
• Data: SQL/NoSQL, MongoDB, CassandraDb, Redis, TimeScale, InfluxDb, CosmosDb, BlobStorage.
• Algorithms, Data Structures, Linear/No-Linear, Dynamic programming, Graph theory, I.R ;
• A.I: Connected self-hosted serving runtimes (Ollama, vLLM) and enterprise cloud APIs.
